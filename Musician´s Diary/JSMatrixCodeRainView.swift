...
fileprivate class JSMatrixDataSource{
    ...
    static func getBrightnessAttributes(brightness: CGFloat) -> [NSAttributedStringKey: Any]{
        return [NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): UIColor.init(hue: 200.0/360.0, saturation: 97.0/100.0, brightness: brightness, alpha: 1.0),
                NSAttributedStringKey.font: UIFont(name: "MusiSync", size: 20)!,
